...
import com.mark1708.botfactorycore.exception.error.ApiError;
import com.mark1708.botfactorycore.exception.error.ForbiddenError;
import com.mark1708.botfactorycore.exception.error.NotFoundError;
import com.mark1708.botfactorycore.exception.error.SimpleApiError;
import com.mark1708.botfactorycore.exception.http.BadRequestException;
import com.mark1708.botfactorycore.exception.http.ResourceForbiddenException;
...
public class ControllerExceptionHandler {
  ...
  public ApiError handleNoResourceFoundException(ResourceNotFoundException e) {
    ...
    return new NotFoundError<>(e.getType(), e.getIds(), e.getMessage());
  }
  ...
  public ApiError handleResourceForbiddenException(ResourceForbiddenException e) {
    ...
    return new ForbiddenError<>(e.getType(), e.getIds(), e.getMessage());
  }
